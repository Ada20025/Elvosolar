...
def init_db():
    ...
    try:
        ...
        cloud_url = os.environ.get('CLOUD_SERVER_URL', 'https://elvosolar-production.up.railway.app') + '/api/cloud/sync-telemetry'
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('cloud_sync_url', ?)", (cloud_url,))
        
        # Smart Meter konfigurácia
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_mode', 'NONE')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_slave_id', '1')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_baudrate', '9600')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_parity', 'N')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_reg_import_wh', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_reg_export_wh', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_reg_import_w', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_reg_export_w', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_reg_consumption_w', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_s0_pin', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_s0_impulses_per_kwh', '1000')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_cloud_api_url', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_cloud_api_token', '')")
        cursor.execute("INSERT OR IGNORE INTO system_settings (key, value) VALUES ('meter_control_mode', 'SMART')")
